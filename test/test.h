...
#define EXPECT_BYTE_EQUAL(a,b,n) do { if( memcmp((a) , (b) , (n) ) != 0 ) { printf("Test failed in %s line %d: expected byte buffers to be equal. len=%d\n", __FILE__ , __LINE__, (n) ); return 1; } } while(0)
